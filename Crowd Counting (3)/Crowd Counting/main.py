...
def SelectStreamScreen():
    ...
    Button(select_stream_frame, text = "Start Stream", font = ("Agency FB", 28, "bold"), relief = FLAT, bd = 0, width=20, fg="#FFFFFF", bg='black', activebackground = "#E3E3E3",activeforeground = "#006EFF", command=lambda:capture_stream_ip()).place(x=25, y = 10)

    def back():
        select_stream_frame.place_forget()
        SelectScreen()

    Button(select_stream_frame, text = "BACK", font = ("Agency FB", 14, "bold"), relief = FLAT, bd = 0, width=20, fg="#FFFFFF", bg='black', activebackground = "#E3E3E3",activeforeground = "#006EFF", command=lambda:back()).place(x=25, y = 25)
...
def SelectImageScreen():
    ...
    Button(select_image_frame, text = "Browse Image", font = ("Agency FB", 28, "bold"), relief = FLAT, bd = 0, width=10, fg="#FFFFFF", bg='black', activebackground = "#E3E3E3",activeforeground = "#006EFF", command=lambda:SelectImageResult()).place(x=150, y = 100)

    Button(select_image_frame, text = "Click Image", font = ("Agency FB", 28, "bold"), relief = FLAT, bd = 0, width=10, fg="#FFFFFF", bg='black', activebackground = "#E3E3E3",activeforeground = "#006EFF", command=lambda:CaptureImageResult()).place(x=450, y = 100)
